# Works, but requires superuser privilege,
# which doesn't work in pyinstaller apps.
# TODO: Use os.system commands instead?
...
def make_drive_bootable(drive, Event = None):
    device_fd = open(drive, "r+b")
...
Format your card in camera before using this script.""" % argv[1], file=sys.stderr)
        return
