...
/* raw write functions */
typedef short (*PTPIOReadFunc)(unsigned char *bytes, unsigned int size, void *data);
typedef short (*PTPIOWriteFunc)(unsigned char *bytes, unsigned int size, void *data);
/*
...
typedef uint16_t (*PTPIOSendData)(PTPParams *params, PTPContainer *ptp, unsigned char *data,
				  unsigned int size);
typedef uint16_t (*PTPIOGetResp)(PTPParams *params, PTPContainer *resp);
typedef uint16_t (*PTPIOGetData)(PTPParams *params, PTPContainer *ptp, unsigned char **data);
/* debug functions */
...
uint16_t ptp_canon_getfolderentries(PTPParams *params, uint32_t store, uint32_t p2,
...
/* CHDK extension */
/******************/
#define PTP_CHDK_VERSION_MAJOR                                                                     \
	2 // increase only with backwards incompatible changes (and reset minor)
...
#define PTP_CHDK_TD_CLEAR                                                                          \
	0x2 // clear the stored data; with DOWNLOAD this                                           \
