...
#define PRINT_PROPVAL_DEC(value) print_propval(dpd.DataType, value, PTPCAM_PRINT_DEC)

#define PRINT_PROPVAL_HEX(value) print_propval(dpd.DataType, value, PTPCAM_PRINT_HEX)
